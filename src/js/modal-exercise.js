...
function openRatingModal(exerciseId) {
  ...
  ratingModalContent.innerHTML = `
    <form class="rating-form" style="position: relative;">
      <button type="button" class="rating-close-btn" data-rating-modal-close>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M18 6L6 18M6 6L18 18" stroke="#F4F4F4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </button>
  ...
  ratingModalContent.querySelector('[data-rating-modal-close]')?.addEventListener('click', closeRatingModal);
...
function renderModal(exercise) {
  ...
  modalContent.innerHTML = `
    <div class="modal-content-grid">
      <img class="modal-img" src="${exercise.gifUrl}" alt="${formatExerciseName(exercise.name)}" />
      <div>
  ...
  <li class="modal-info-item">
    ...
    <span class="modal-info-value">${formatExerciseName(exercise.target)}</span>
  </li>
  <li class="modal-info-item">
    <span class="modal-info-label">Body Part</span>
    <span class="modal-info-value">${formatExerciseName(exercise.bodyPart)}</span>
  </li>
  <li class="modal-info-item">
    <span class="modal-info-label">Equipment</span>
    <span class="modal-info-value">${formatExerciseName(exercise.equipment)}</span>
  </li>
  <li class="modal-info-item">
    <span class="modal-info-label">Popular</span>
    <span class="modal-info-value">${formatExerciseName(exercise.popularity.toString())}</span>
  </li>
  <li class="modal-info-item">
    <span class="modal-info-label">Burned Calories</span>
    <span class="modal-info-value">${exercise.burnedCalories} / 3 min</span>
  </li>
</ul>

        <p>${formatExerciseName(exercise.description)}</p>
